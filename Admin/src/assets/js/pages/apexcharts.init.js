...
ChartColorChange(chart,'#line_chart_datalabel');
...
chart.render();
ChartColorChange(chart,'#line_chart_dashed');
...
chart.render();
ChartColorChange(chart,'#column_chart');
...
chart.render();
ChartColorChange(chart,'#bar_chart');
...
var options = {
  ...
  chart.render();
  ChartColorChange(chart,'#mixed_chart');
...
chart.render();
ChartColorChange(chart,'#radial_chart');
...
chart.render();
ChartColorChange(chart,'#pie_chart');
...
var options = {
  ...
  labels: ['Series 1', 'Series 2', 'Series 3', 'Series 4', 'Series 6'],
  colors: donutColors,
  legend: {
      show: true,
      position: 'bottom',
...
ChartColorChange(chart,'#donut_chart');